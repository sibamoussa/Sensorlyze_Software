"""
Sensorlyze: Source Code Vers. 1.0.0

Copyright (c) 2020 Siba Moussa
...
A separate class has been defined for each experiment type (Single Sensors, Multiple Sensors, Quantification , etc...) which consists of the set of functions required to process it.
"""
...
################# UNDER DEVELOPMENT#########################################
          ...
          self.window.setGeometry(1500, 800, 800, 500)
          self.window.show()
