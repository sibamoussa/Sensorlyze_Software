    ...
    def plot_file_datavis(self):
        ...
        for array in df_split:
            if file_index <= ind-1:
                ...
                pen = pg.mkPen(color=(25+plot_color, 25+plot_color, 125+plot_color))
               ...
               #graphWidget.LegendItem(size=None, offset=None, horSpacing=25, labelTextSize='12pt')
                graphWidget.addLegend(offset=None, horSpacing=25, labelTextSize='12pt',labelTextColor='k')
                #plotting
